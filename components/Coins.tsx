  ...
  return (
    <div className="flex-center flex-col items-center bg-black text-white min-h-screen poppins-regular">
      <div className='w-full h-[200px] flex-center poppins-bold relative'>
          <h1 className='text-[9.4rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#171131] via-indigo-700 to-purple-900 drop-shadow-lg'>
            C
          </h1>
          <h1 className='text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-600 drop-shadow-md'>
            rypto <br/> rruncies
          </h1>
